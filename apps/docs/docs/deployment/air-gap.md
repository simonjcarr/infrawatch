...
From **Administration → Agents → Enrolment**, an `instance_admin` or `super_admin` clicks **Download Install Bundle**, picks the target OS / arch, and downloads a zip containing:
