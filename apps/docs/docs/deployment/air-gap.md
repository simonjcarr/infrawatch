...
From **Administration → Agents → Enrolment**, an `org_admin` or `super_admin` clicks **Download Install Bundle**, picks the target OS / arch, and downloads a zip containing:
