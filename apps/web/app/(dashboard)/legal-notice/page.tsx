...
const sections = [
  ...
  {
    title: '4. Security, secrets, and data exposure',
    body: [
  ...
  {
    title: '11. Jurisdiction-specific rights',
    body: [
  ...
  {
    title: '12. Conflicts and changes',
    body: [
