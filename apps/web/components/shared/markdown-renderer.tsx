...
// Rendered inside a host-detail card — matches the rest of the app's typography
// (no @tailwindcss/typography plugin is configured). Links open in a new tab so
// engineers can keep the note open while following a ticket / PR reference.
