...
const auditedLifecycleActions = [
  ...
  ['agents-core.ts', agentsSource, 'approveAgent', ['agent.approved']],
  ['agents-core.ts', agentsSource, 'rejectAgent', ['agent.rejected']],
  ['agents-core.ts', agentsSource, 'revokeEnrolmentToken', ['agent.enrolment_token.revoked']],
]
