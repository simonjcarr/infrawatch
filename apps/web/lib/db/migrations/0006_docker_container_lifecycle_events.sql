...
CREATE INDEX "docker_container_lifecycle_events_instance_host_time_idx" ON "docker_container_lifecycle_events" USING btree ("instance_id","host_id","occurred_at");--> statement-breakpoint
CREATE INDEX "docker_container_lifecycle_events_instance_container_time_idx" ON "docker_container_lifecycle_events" USING btree ("instance_id","docker_container_row_id","occurred_at");
