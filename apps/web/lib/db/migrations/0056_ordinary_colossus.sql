...
CREATE TABLE "password_vault_key_epochs" (
	...
	"wrap_version" text DEFAULT 'v1' NOT NULL,
	"rotation_reason" text DEFAULT 'initial_setup' NOT NULL,
...
CREATE INDEX "password_vault_entries_vault_updated_idx" ON "password_vault_entries" USING btree ("vault_id","updated_at");--> statement-breakpoint
CREATE INDEX "password_vault_entries_org_vault_idx" ON "password_vault_entries" USING btree ("organisation_id","vault_id");--> statement-breakpoint
...
CREATE INDEX "password_vault_members_user_revoked_idx" ON "password_vault_members" USING btree ("user_id","revoked_at");--> statement-breakpoint
