...
assert_contains "${REPO_ROOT}/apps/web/lib/automation/ansible-api.ts" "pairAnsibleApi"
assert_contains "${REPO_ROOT}/apps/ansible-api/Dockerfile" "/var/lib/ct-ops/ansible-api"
assert_contains "${REPO_ROOT}/apps/ansible-api/server.py" "ANSIBLE_API_PAIRING_USERNAME"
