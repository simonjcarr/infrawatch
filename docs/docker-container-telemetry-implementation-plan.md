...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Define Docker telemetry protobuf contract | unclaimed | pending | `proto/agent/v1/*.proto`, generated Go protobufs | None | Messages represent Docker status, container inventory, metric samples, batch ids, dropped sample counts, and payload limits. Existing agents remain compatible. | TBD | Prefer a dedicated telemetry RPC if payload size would make heartbeat fragile. |
