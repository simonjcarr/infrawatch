...
| Document retention behavior | Codex | review | docs site, feature docs | Retention implementation | Docs explain defaults, overrides, storage impact, and cleanup timing. | [#1378](https://github.com/carrtech-dev/ct-ops/pull/1378) | PR #1378 adds operator-facing Docker telemetry docs, links ingest retention behavior, and includes sizing caveats for large fleets. |
