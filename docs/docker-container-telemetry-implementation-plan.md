...
| Add per-container metric charts | Codex | review | web actions, chart components, e2e/component tests | Stored metrics | UI shows CPU, memory, network, block I/O, and pids over time with avg and max where bucketed. | [#1365](https://github.com/carrtech-dev/ct-ops/pull/1365) | Opened #1365. Max line/area is required to preserve spike visibility. Local E2E blocked by missing container runtime. |
