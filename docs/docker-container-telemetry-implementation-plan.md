...
| Implement retention sweeper | Codex | review | ingest sweeper or web maintenance job, tests | Global and host settings | Rows are deleted according to each host's effective retention. | [#1375](https://github.com/carrtech-dev/ct-ops/pull/1375) | Ingest sweeper deletes metrics by host-effective retention and purges Docker telemetry batch records after 7 days. |
