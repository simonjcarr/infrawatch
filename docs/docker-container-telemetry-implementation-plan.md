...
| Document retention behavior | Codex | in_progress | docs site, feature docs | Retention implementation | Docs explain defaults, overrides, storage impact, and cleanup timing. | TBD | Claiming 2026-05-13 to add operator-facing retention documentation. Include sizing caveats for large fleets. |
