...
| Task | Owner | Status | Files / Areas | Dependencies | Acceptance Criteria | PR | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Add global Docker retention setting | Codex | in_progress | Administration/settings UI and actions | Phase 0 settings contract | Admin can configure Docker metric retention days; default is 30. | TBD | Implementing Docker-specific `dockerMetricRetentionDays` setting per Phase 0 contract. |
