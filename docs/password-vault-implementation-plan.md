...
| 5 | Add vault schema and migration | 4 | In progress | automation/work-on-password-manager (2026-05-04 13:17 BST) |  | Add Drizzle schema, migration, exports, and E2E truncate entries for user keys, vaults, key epochs, members, entries, and audit references. |
