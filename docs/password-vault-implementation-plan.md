...
| 10 | Implement vault CRUD API | 9 | In progress | automation/work-on-password-manager 2026-05-04T16:30Z |  | Add create/list/update/delete vault endpoints using encrypted display payloads and backend membership enforcement. |
