...
| 3 | Add public docs shell and navigation | 2 | Complete | automation/work-on-password-manager | [#885](https://github.com/carrtech-dev/ct-ops/pull/885) | Added `apps/docs/docs/features/password-vault.md`, wired it into the VuePress sidebar and docs homepage quick links, and documented MVP scope plus recovery limits without promising deferred features. |
...
| 2026-05-04 | automation/work-on-password-manager | 3 | Complete | [#885](https://github.com/carrtech-dev/ct-ops/pull/885) | `git diff --check`; `pnpm --filter @ct-ops/docs build` | Added the public Password Vault feature page, linked it from the VuePress sidebar and homepage quick links, and kept the copy scoped to the MVP plus explicit no-recovery limits. |
