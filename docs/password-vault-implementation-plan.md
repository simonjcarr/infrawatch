...
| 3 | Add public docs shell and navigation | 2 | In progress | automation/work-on-password-manager @ 2026-05-04T12:13:15Z |  | Add `apps/docs/docs/features/password-vault.md`, wire it into the docs sidebar, and describe MVP behavior without promising deferred features. |
